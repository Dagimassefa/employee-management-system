 ...
 * @author User
 */
public class ListAttendance extends javax.swing.JFrame {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    for (int i = 0; i <= c; i++) {
                        ...
                        v2.add(rs.getString("first_half"));
                        v2.add(rs.getString("second_half"));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee Id", "First half", "Second half", "Date"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new ListAttendance().setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
